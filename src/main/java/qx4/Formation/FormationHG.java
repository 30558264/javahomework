...
public class FormationHG implements Formation {
    @Override
    public void formation(Creatures creatures)
    {
        if(creatures.isCamp())
        {
            ...
            creatures.getCreatures().get(5).setPosition(new Position(5,(Global.getM()-1)/2+2));
            creatures.getCreatures().get(6).setPosition(new Position(4,(Global.getM()-1)/2+3));
            creatures.getCreatures().get(7).setPosition(new Position(5,(Global.getM()-1)/2+4));
            ...
            creatures.getCreatures().get(5).setImageView(new Position(5,(Global.getM()-1)/2+2));
            creatures.getCreatures().get(6).setImageView(new Position(4,(Global.getM()-1)/2+3));
            creatures.getCreatures().get(7).setImageView(new Position(5,(Global.getM()-1)/2+4));
        }
        else
        {
            ...
            creatures.getCreatures().get(5).setPosition(new Position(Global.getN()-6,(Global.getM()-1)/2+2));
            creatures.getCreatures().get(6).setPosition(new Position(Global.getN()-5,(Global.getM()-1)/2+3));
            creatures.getCreatures().get(7).setPosition(new Position(Global.getN()-6,(Global.getM()-1)/2+4));
            ...
            creatures.getCreatures().get(5).setImageView(new Position(Global.getN()-6,(Global.getM()-1)/2+2));
            creatures.getCreatures().get(6).setImageView(new Position(Global.getN()-5,(Global.getM()-1)/2+3));
            creatures.getCreatures().get(7).setImageView(new Position(Global.getN()-6,(Global.getM()-1)/2+4));
        }
    }
}
